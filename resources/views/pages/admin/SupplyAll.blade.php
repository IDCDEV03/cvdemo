...
<div class="container-fluid">
    ...
    <div class="card shadow-sm mb-20">
        <div class="tbl-header d-flex align-items-center justify-content-between">
            <span class="fw-bold text-white fs-16"><i class="uil uil-building me-2"></i>รายการ Supply ทั้งหมด ({{ $supply_list->count() }} รายการ)</span>
            <a href="{{ route('admin.sup_create') }}" class="btn btn-sm btn-light fw-600">
        ...
        <div class="card-body p-3">
            <div class="table-responsive">
                <table id="supplyTable" class="table table-hover mb-0" style="width:100%">
                    ...
                    <tbody>
                        @foreach ($supply_list as $i => $item)
                        <tr>
                            <td class="text-muted text-center">{{ $i + 1 }}</td>
                            <td>
                                <a href="{{ route('admin.sup_edit', $item->user_id) }}"
                            ...
                            <td><span class="company-chip">{{ $item->company_name }}</span></td>
                            <td>
